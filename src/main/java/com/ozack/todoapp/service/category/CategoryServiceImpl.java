...
public class CategoryServiceImpl implements CategoryService {
    ...
    private final String insertErrorMessageByRuntime = "category データ登録時に予期しないエラーが発生しました。";
    private final String updateErrorMessageByDataAccess = "category データ更新時にデータベース関連のエラーが発生しました。";
    private final String updateErrorMessageByRuntime = "category データ更新時に予期しないエラーが発生しました。";
